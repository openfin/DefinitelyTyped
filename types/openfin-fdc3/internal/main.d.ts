 ...
 */
export function open(name: AppName, context?: Context): Promise<void>;
/**
 ...
 * @throws `TypeError` if `context` is not a valid [[Context]].
 */
export function raiseIntent(intent: string, context: Context, target?: AppName): Promise<IntentResolution>;
/**
