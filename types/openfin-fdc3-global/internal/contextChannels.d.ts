 ...
 */
export const defaultChannel: DefaultChannel;
/**
 ...
 */
export function getSystemChannels(): Promise<SystemChannel[]>;
/**
 ...
 */
export function getChannelById(channelId: ChannelId): Promise<Channel>;
/**
 ...
 * {@link https://developer.openfin.co/docs/javascript/stable/global.html#Identity | Identity}.
 */
export function getCurrentChannel(identity?: Identity): Promise<Channel>;
/**
 ...
 */
export function getOrCreateAppChannel(name: string): Promise<AppChannel>;
